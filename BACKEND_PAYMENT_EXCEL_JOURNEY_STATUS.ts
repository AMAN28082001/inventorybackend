 ...
 *
 * Implemented in this repo (HANDOFF §24–§25):
 *   - utils/paymentExcelJourneyStatus.ts — Installation + Metering FILE STATUS labels
 *   - GET /quotations?status=approved echoes release / partial / approved fields
 *
