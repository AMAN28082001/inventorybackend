...
interface ProductSerialNumberCreationAttributes extends Optional<ProductSerialNumberAttributes, 'id' | 'stock_addition_id' | 'owner_id' | 'owner_type' | 'status' | 'created_at' | 'updated_at'> {}
